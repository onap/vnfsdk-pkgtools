...
public class EvelHeader {
	...
	final int EVEL_HEADER_MINOR_VERSION = 1;
	  ...
	  PRIORITIES priority;
	  static Long start_epoch_microsec = 0L;
	  static Long last_epoch_microsec = 0L;
	  int sequence;
	   ...
	   *****************************************************************************/
	  public EvelHeader(String eventname)
	  {
	    EVEL_ENTER();
	    ...
	    try
	    {
	        ...
	        //Stores unique mac address into UUID
	        byte[] macAddress = networkInterface.getHardwareAddress();
	        uuid = bytesToHex(macAddress);
	    }
	  ...
	  public static EvelHeader evel_new_heartbeat()
	  {
	    ...
	    /* everything downstream can cope with nulls.                              */
	    /***************************************************************************/
	    header = new EvelHeader("Heartbeat");
	...
	/**************************************************************************//**
	   ...
	   *                      returns.
	   *****************************************************************************/
	  void evel_header_type_set(String type)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_start_epoch_set(Long epoch_microsec)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_last_epoch_set(Long epoch_microsec)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_nfcnamingcode_set(String nfcnam)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_nfnamingcode_set(String nfnam)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_reporting_entity_name_set(String entity_name)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_reporting_entity_id_set(String entity_id)
	  {
	    EVEL_ENTER();
