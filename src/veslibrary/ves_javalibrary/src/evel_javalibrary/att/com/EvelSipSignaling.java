...
public class EvelSipSignaling extends EvelHeader {
	...
	/***************************************************************************/
	   ...
	   *
	   *****************************************************************************/
	  public EvelSipSignaling(String vendr_name,
              String corlator,
	   ...
	   *                      function returns.
	   *****************************************************************************/
	  void evel_signaling_local_ip_address_set(
	   ...
	   *                      returns.
	   *****************************************************************************/
	  void evel_signaling_local_port_set(String loc_port)
	  {
	    EVEL_ENTER();
	   ...
	   *                      function returns.
	   *****************************************************************************/
	  void evel_signaling_remote_ip_address_set(String remip_address)
	  {
	    EVEL_ENTER();
	   ...
	   *                      returns.
	   *****************************************************************************/
	  void evel_signaling_remote_port_set(String rem_port)
	  {
	    EVEL_ENTER();
	   ...
	   *                      returns.
	   *****************************************************************************/
	  void evel_signaling_vnfmodule_name_set(String module_name)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_signaling_vnfname_set(String vnfname)
	  {
	    EVEL_ENTER();
	   ...
	   *                      returns.
	   *****************************************************************************/
	  void evel_signaling_compressed_sip_set(String compr_sip)
	  {
	    EVEL_ENTER();
	   ...
	   *                      returns.
	   *****************************************************************************/
	  void evel_signaling_summary_sip_set(String summ_sip)
	  {
	    EVEL_ENTER();
	   ...
	   *                      returns.
	   *****************************************************************************/
	  void evel_signaling_correlator_set(String corlator)
	  {
	    EVEL_ENTER();
