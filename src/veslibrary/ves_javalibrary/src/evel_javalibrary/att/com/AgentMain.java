...
/*
import veslibrary.att.com.EvelFault.EVEL_SEVERITIES;
import veslibrary.att.com.EvelFault.EVEL_SOURCE_TYPES;
import veslibrary.att.com.EvelFault.EVEL_VF_STATUSES;
import veslibrary.att.com.EvelScalingMeasurement.MEASUREMENT_CPU_USE;
import veslibrary.att.com.EvelScalingMeasurement.MEASUREMENT_VNIC_PERFORMANCE;
import veslibrary.att.com.AgentMain.EVEL_ERR_CODES;
*/
...
public enum EVEL_ERR_CODES {
  ...
  EVEL_MAX_ERROR_CODES            /** Maximum number of valid error codes.   */
    	  ...
    	  if( (datatosend = (String) ringb.take()) != null )
    	  {
			  ...
			  try {
                ...
                case HttpURLConnection.HTTP_UNAUTHORIZED:
                    ...
                    System.out.println(url + " **unauthorized**");
                    break;// retry
                ...
                default:
                    logger.error(url+" **unknown response code**.");
                    break; // abort
                }
     ...
     * @param   throt_api_url    The optional path (may be NULL).
     ...
     *****************************************************************************/
    public static EVEL_ERR_CODES evel_initialize(String event_api_url,
    		int port,
            String throt_api_url,
            String username,
            String password,
            Level level) throws IOException
    {
  		...
  		url = event_api_url+":"+Integer.toString(port)+"/vendor_event_listener/eventListener/v5/example_vnf";
  		vesurl = null;
		try {
			vesurl = new URL(url);
		} catch (MalformedURLException e) {
