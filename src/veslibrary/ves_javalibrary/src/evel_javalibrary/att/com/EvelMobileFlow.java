...
public class EvelMobileFlow extends EvelHeader {
	...
	/**************************************************************************//**
	   ...
	   *                    returns.
	   *****************************************************************************/
	  void evel_mobile_flow_type_set(String typ)
	  {
		    EVEL_ENTER();
		    assert(typ != null);
	   ...
	   *                    returns.
	   *****************************************************************************/
	  void evel_mobile_flow_app_type_set(String type)
	  {
	    EVEL_ENTER();
	   ...
	   *                    function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_app_prot_type_set(String type)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_mobile_flow_cid_set(String cd)
	  {
	    EVEL_ENTER();
	   ...
	   *                    returns.
	   *****************************************************************************/
	  void evel_mobile_flow_con_type_set(String type)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_ecgi_set(String ecgit)
	  {
	    EVEL_ENTER();
	   ...
	   *                    function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_gtp_prot_type_set(String type)
	  {
	    EVEL_ENTER();
	   ...
	   *                    function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_gtp_prot_ver_set(String version)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_mobile_flow_http_header_set(String header)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_imei_set(String imeit)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_imsi_set(String imsit)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_lac_set(String lact)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_mcc_set(String mcct)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_mnc_set(String mnct)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_msisdn_set(String msisdnt)
	  {
	    EVEL_ENTER();
	   ...
	   *                    function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_other_func_role_set(String role)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_rac_set(String ract)
	  {
	    EVEL_ENTER();
	   ...
	   *                    function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_radio_acc_tech_set(String tech)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_sac_set(String sact)
	  {
	    EVEL_ENTER();
	   ...
	   *****************************************************************************/
	  void evel_mobile_flow_samp_alg_set(
	                                     int algorithm)
	  {
	    EVEL_ENTER();
	   ...
	   *                    need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_tac_set(String tact)
	  {
	    EVEL_ENTER();
	   ...
	   *                    not need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_tunnel_id_set(String tunnel_idt)
	  {
	    EVEL_ENTER();
	   ...
	   *                    not need to preserve the value once the function returns.
	   *****************************************************************************/
	  void evel_mobile_flow_vlan_id_set(String vlan_idt)
	  {
	    EVEL_ENTER();
