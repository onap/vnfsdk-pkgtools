...
public class Main
{
       ...
       try{
        ...
        AgentMain.evel_initialize("http://127.0.0.1", 30000,
                              "http://127.0.0.1",
        //AgentMain.evel_initialize("http://135.91.182.244",
        //                "http://135.91.182.244",
                "pill",
                "will",
                Level.DEBUG);
       } catch( Exception e )
       {
        ...
        for(int i= 0; i < 2; i++)
        {
              EvelHeader header  = EvelHeader.evel_new_heartbeat();
              ...
              EvelFault flt  = new EvelFault("NIC error", "Hardware failed",
              ...
              EvelStateChange stc  = new EvelStateChange(EvelStateChange.EVEL_ENTITY_STATE.EVEL_ENTITY_STATE_IN_SERVICE,
              ...
              EvelScalingMeasurement sm  = new EvelScalingMeasurement(10.0);
              ...
              EvelSyslog sysl = new EvelSyslog(EvelFault.EVEL_SOURCE_TYPES.EVEL_SOURCE_ROUTER,
            		                   "Router failed","JUNIPER");
              sysl.evel_syslog_proc_id_set(456);
              sysl.evel_syslog_proc_set("routed");
              AgentMain.evel_post_event(sysl);
              
              EvelHeartbeatField hfld = new EvelHeartbeatField(123);
              hfld.evel_hrtbt_interval_set(23);
              AgentMain.evel_post_event(hfld);
              
              
              EvelSipSignaling sip = new EvelSipSignaling("aricent","corlator","127.0.0.1","5647","10.1.1.124","5678");
              AgentMain.evel_post_event(sip);
              
              EvelVoiceQuality vq = new EvelVoiceQuality("calleeSideCodc",
              ...
              EvelThresholdCross tca = new EvelThresholdCross(
              "CRIT",
              "mcast Limit reached",
              "mcastRxPackets",
              "1250000000",
              ...
              EvelMobileFlow mf = new EvelMobileFlow("In",
                      null,
                      "GTP",
                       "v2.3",
                      "1.2.3.4",
